...
<body class="hold-transition login-page">
    <div class="container-fluid flex flex-col justify-center items-center text-dark p-5"
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="text-content">
                        ...
                        <p class="testimonial-text">web ini dibuat menggunakan hati yang ikhlas, sehingga tampilan dan semua fitur enak dilihat, dan semua pelayanan diweb ini sangat cepat dan mudah digunakan </p>
                    </div>
                </div>
            </div>
        </div>
